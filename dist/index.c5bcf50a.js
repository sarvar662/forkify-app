...
})({"hxUaS":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "2791a21ac5bcf50a";
...
var _renderRecipeJs = require("./vievs/renderRecipe.js");
var _renderRecipeJsDefault = parcelHelpers.interopDefault(_renderRecipeJs);
var _searchViewJs = require("./vievs/searchView.js");
var _searchViewJsDefault = parcelHelpers.interopDefault(_searchViewJs);
var _searchViewResultsJs = require("./vievs/searchViewResults.js");
var _searchViewResultsJsDefault = parcelHelpers.interopDefault(_searchViewResultsJs);
var _bookmarkShowJs = require("./vievs/bookmarkShow.js");
var _bookmarkShowJsDefault = parcelHelpers.interopDefault(_bookmarkShowJs);
var _addRecipeJs = require("./vievs/addRecipe.js");
...
let getRecipe = async function() {
    try {
        ...
        _renderRecipeJsDefault.default.render(_moduleJs.state.recipe);
    } catch (err) {
        console.log(err);
    }
};
...
const renderSearchResults = async function() {
    ...
    _searchViewResultsJsDefault.default.render(_moduleJs.paginationLoad());
    _paginationViewJsDefault.default.render(_moduleJs.state.search);
};
_searchViewJsDefault.default.addSearchHandler(renderSearchResults);
const paginationUpdate = function(page) {
    _searchViewResultsJsDefault.default.render(_moduleJs.paginationLoad(Number(page)));
    _paginationViewJsDefault.default.render(_moduleJs.state.search);
};
_paginationViewJsDefault.default.changePage(paginationUpdate);
const controlServings = function(newServings) {
    _moduleJs.updateServings(newServings);
    _renderRecipeJsDefault.default.render(_moduleJs.state.recipe);
};
_renderRecipeJsDefault.default.addEventHandlerServings(controlServings);
const controlBookmark = function() {
    if (_moduleJs.state.recipe.bookmarked) _moduleJs.deleteBookmarks(_moduleJs.state.recipe.id);
    else _moduleJs.addToBookmarks(_moduleJs.state.recipe);
    _renderRecipeJsDefault.default.render(_moduleJs.state.recipe);
    _bookmarkShowJsDefault.default.render(_moduleJs.state.bookmarks);
};
_renderRecipeJsDefault.default.addEventHandlerBookmark(controlBookmark);
const controlRenderBookmark = async function() {
    await _moduleJs.loadBookmark();
    _bookmarkShowJsDefault.default.render(_moduleJs.state.bookmarks);
    console.log(_moduleJs.state.bookmarks);
};
_bookmarkShowJsDefault.default.addEventHandlerBtn(controlRenderBookmark);
let addNewRecipe = async function(data) {
    await _moduleJs.createRecipe(data);
    _renderRecipeJsDefault.default.render(_moduleJs.state.recipe);
    window.history.pushState(null, '', `#${_moduleJs.state.recipe.id}`);
};
_addRecipeJsDefault.default.addHandlerSubmit(addNewRecipe);

},{"core-js/modules/web.immediate.js":"49tUX","./module.js":"Qr6Q3","./vievs/paginationView.js":"gxNib","./vievs/renderRecipe.js":"idaEI","./vievs/searchView.js":"3tbYO","./vievs/searchViewResults.js":"b9pmI","./vievs/bookmarkShow.js":"gewQd","./vievs/addRecipe.js":"l471v","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
parcelHelpers.export(exports, "paginationLoad", ()=>paginationLoad
);
...
parcelHelpers.export(exports, "loadBookmark", ()=>loadBookmark
);
parcelHelpers.export(exports, "createRecipe", ()=>createRecipe
);
const state = {
    recipe: {
    },
...
const paginationLoad = function(page = state.search.page) {
...
const deleteBookmarks = function(recipe) {
    let index = state.bookmarks.findIndex((el)=>{
        el.id, recipe.id;
    });
...
const loadBookmark = async function() {
    if (localStorage.length === 0) return;
    let data = await JSON.parse(localStorage.getItem("bookmarks"));
    state.bookmarks = data;
};
const createRecipe = async function(newRecipe) {
    try {
...
},{}],"gxNib":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class PaginationView {
    ...
    _generateMarkup(data) {
        ...
        if (data.page === 1 && pageNum > 1) return `<button class = "btn-pagination next" data-page ="${data.page + 1}"> Page ${data.page + 1}> </button>`;
        if (data.page > 1 && data.page < pageNum) return `
                ...
                `;
        if (data.page === pageNum && pageNum > 1) return `
                <button class = "btn-pagination prev" data-page ="${data.page - 1}">Page${data.page - 1}</button>
            `;
        return '';
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"idaEI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class RecipeView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3tbYO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b9pmI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new SearchViewResults();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gewQd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class BookmarkShow {
...
exports.default = new BookmarkShow();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l471v":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class AddRecipe {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hxUaS","iIJIp"], "iIJIp", "parcelRequire2e0c")

//# sourceMappingURL=index.c5bcf50a.js.map
